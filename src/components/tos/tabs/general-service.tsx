...
const GeneralService = () => {
    return (
        <Fragment>
            <ServiceCard>
                <BannerHeading isLeft text="WEBSITE AND GENERAL SERVICES" isBlue />
